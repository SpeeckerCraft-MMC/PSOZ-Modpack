...
#modloaded fluidcows cookingforblockheads extendedcrafting bloodmagic
...
<fluidcows:cow_halter>.addTooltip(format.green("Bloodmagic Compat")+format.white(" - ")+format.darkPurple("Beast"+format.white(" Mode")));
