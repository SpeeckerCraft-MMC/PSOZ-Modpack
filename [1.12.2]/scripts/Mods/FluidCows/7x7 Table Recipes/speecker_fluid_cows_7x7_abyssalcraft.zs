...
#modloaded fluidcows cookingforblockheads extendedcrafting abyssalcraft
...
val Solids = {
    motlenabyssalnite : [<abyssalcraft:ingotblock:0>],
    moltenrefinedcoralium : [<abyssalcraft:ingotblock:1>],
    motlendreadium : [<abyssalcraft:ingotblock:2>]
