...
#modloaded fluidcows cookingforblockheads extendedcrafting enderio
...
val Solids = {
    conductive_iron : [<enderio:block_alloy:4>],
    construction_alloy : [<enderio:block_alloy:9>],
    crude_steel : [<enderio:block_alloy_endergy:0>],
    crystalline_alloy : [<enderio:block_alloy_endergy:1>],
    crystalline_pink_slime : [<enderio:block_alloy_endergy:4>],
    dark_steel : [<enderio:block_alloy:6>],
    ...
    soularium : [<enderio:block_alloy:7>],
    stellar_alloy : [<enderio:block_alloy_endergy:3>],
    vivid_alloy : [<enderio:block_alloy_endergy:6>],
    vibrant_alloy : [<enderio:block_alloy:2>]
...
<fluidcows:cow_halter>.addTooltip(format.green("EnderIO Compat")+format.white(" - ")+format.darkPurple("Beast"+format.white(" Mode")));
