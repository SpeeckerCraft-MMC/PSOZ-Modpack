...
#modloaded fluidcows cookingforblockheads extendedcrafting bigreactors tinkersreforged
...
val Solids = {
    cyanite : [<bigreactors:blockbcyanite>],
    blutonium : [<bigreactors:blockblutonium>],
    ludicrite : [<bigreactors:blockludicrite>],
    yellorium : [<bigreactors:blockyellorium>]
...
<fluidcows:cow_halter>.addTooltip(format.green("BigReactors (TinkersReforged) Compat")+format.white(" - ")+format.darkPurple("Beast"+format.white(" Mode")));
