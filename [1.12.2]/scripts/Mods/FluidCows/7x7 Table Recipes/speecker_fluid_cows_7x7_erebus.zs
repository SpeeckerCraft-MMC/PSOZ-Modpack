...
#modloaded fluidcows cookingforblockheads extendedcrafting erebus
...
<fluidcows:cow_halter>.addTooltip(format.green("Erebus Compat")+format.white(" - ")+format.darkPurple("Beast"+format.white(" Mode")));
