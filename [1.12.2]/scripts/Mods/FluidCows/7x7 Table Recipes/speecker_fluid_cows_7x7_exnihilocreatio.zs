...
#modloaded fluidcows cookingforblockheads extendedcrafting exnihilocreatio
...
<fluidcows:cow_halter>.addTooltip(format.green("ExNihiloCreatio Compat")+format.white(" - ")+format.darkPurple("Beast"+format.white(" Mode")));
