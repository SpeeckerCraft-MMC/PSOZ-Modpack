...
recipes.addShaped("speecker_beast_enderio_block_transceiver", <enderio:block_transceiver>, [[<ore:ingotCrystallinePinkSlime>, <fluxnetworks:fluxcontroller>, <ore:ingotCrystallinePinkSlime>],[<ore:skullEnderResonator>, <ore:itemEnderCrystal>, <ore:skullEnderResonator>], [<ore:ingotCrystallinePinkSlime>, <enderio:item_capacitor_stellar>, <ore:ingotCrystallinePinkSlime>]]);
