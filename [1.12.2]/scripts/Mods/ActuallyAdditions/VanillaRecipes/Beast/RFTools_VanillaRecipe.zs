...
#modloaded crafttweaker modtweaker actuallyadditions rftools
...
static modExtern as string = "rftools";
...
//	[<IIngredient:toRemove>.withTag({NBTtag})]: bool //if true the recipe will only be removed if the Optional NBT-Tag matches
  [<actuallyadditions:block_item_repairer>]: false
};
...
//	name: { <minecraft:output>: [IIngredients] },
	item_repairer: { <actuallyadditions:block_item_repairer>: [[[<actuallyadditions:block_crystal_empowered:2>, <rftools:infused_diamond>, <actuallyadditions:block_crystal_empowered:2>],[<actuallyadditions:item_misc:7>, <actuallyadditions:block_misc:8>, <actuallyadditions:item_misc:7>], [<actuallyadditions:block_crystal_empowered:2>, <ore:blockTerrasteel>, <actuallyadditions:block_crystal_empowered:2>]]] }
};
