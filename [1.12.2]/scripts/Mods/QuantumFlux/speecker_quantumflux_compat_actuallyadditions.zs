#modloaded modtweaker actuallyadditions quantumflux
...
Empowerer.addRecipe(<quantumflux:craftingpiece:2>, <appliedenergistics2:material:22>, <quantumflux:darkstone:0>, <ore:ingotUranium>, <thermalsolars:itemlunaringot>, <quantumflux:darkstone>, 10000, 8, [0.1,0.1,0.1]);
