...
//old recipe with openmodularturrets as dependancy
...
recipes.addShaped("speecker_beast_overloaded_railgun", <overloaded:railgun>, [[null, <embers:ember_cartridge>, <draconicevolution:magnet:1>],[<ore:blockNetherStar>, <overloaded:energy_core>, <embers:ember_cartridge>], [<thermalinnovation:magnet:*>, <enderio:item_magnet>, <magneticraft:crafting:4>]]);
