...
recipes.addShaped("speecker_beast_mekanism_machineblock_8", <mekanism:machineblock:8>, [[<ore:ingotRedstoneAlloy>, <nuclearcraft:nuclear_furnace>, <ore:ingotRedstoneAlloy>], [<ore:ingotOsmium>, <mekanism:basicblock:8>, <ore:ingotOsmium>], [<ore:ingotRedstoneAlloy>, <nuclearcraft:nuclear_furnace>, <ore:ingotRedstoneAlloy>]]);
