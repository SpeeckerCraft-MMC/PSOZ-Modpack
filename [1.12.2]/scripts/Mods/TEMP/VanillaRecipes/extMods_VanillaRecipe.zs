...
static modIntern as string = "internMod"; //The Mod the output is from.
static modExtern as string = "externMod"; //The Mods the ingredients are from. For multiple entries use "_" as seperator
