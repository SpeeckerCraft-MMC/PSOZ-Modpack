...
//recipes.addShaped("speecker_beast_cyclicmagic_block_storeempty", <cyclicmagic:block_storeempty>, [[<ore:ingotIron>, <ore:obsidian>, <ore:ingotIron>], [<ore:obsidian>, <enderio:block_tank:1>|<extracells:certustank>|<magneticraft:small_tank:0>|<mob_grinding_utils:tank>, <ore:obsidian>], [<ore:ingotIron>, <ore:obsidian>, <ore:ingotIron>]]);
