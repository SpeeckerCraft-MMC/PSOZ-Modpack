...
val BoronNitride = RB.newBuilder("duplicator_armor_boronnitride", "duplicator", 13, 0);
    ...
    BoronNitride.addItemInput(<nuclearcraft:helm_boron_nitride>);
    BoronNitride.setChance(0.00);
    BoronNitride.addItemInput(<nuclearcraft:chest_boron_nitride>);
    BoronNitride.setChance(0.00);
    BoronNitride.addItemInput(<nuclearcraft:legs_boron_nitride>);
    BoronNitride.setChance(0.00);
    BoronNitride.addItemInput(<nuclearcraft:boots_boron_nitride>);
    BoronNitride.setChance(0.00);
