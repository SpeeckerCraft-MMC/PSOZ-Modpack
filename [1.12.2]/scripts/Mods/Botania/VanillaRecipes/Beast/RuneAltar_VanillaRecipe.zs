#priority -99
#packmode beast
#modloaded crafttweaker botania lordcraft randomthings
...
static modExtern as string = "lordcraft_randomthings";
...
//	name: {<minecraft:output>: [IIngredients]},
  runealtar: {<botania:runealtar>: [[[<lordcraft:crystal_basic_nature>, <randomthings:spectreilluminator>, <lordcraft:crystal_basic_nature>],[<ore:livingrock>, <ore:livingrock>, <ore:livingrock>], [<ore:livingrock>, <ore:manaPearl>, <ore:livingrock>]]]}
};
