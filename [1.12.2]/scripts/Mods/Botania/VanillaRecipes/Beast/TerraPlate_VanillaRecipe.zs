#priority -99
#packmode beast
#modloaded crafttweaker botania embers soot
...
static modExtern as string = "embers_soot";
...
//	name: {<minecraft:output>: [IIngredients]},
  terraplate: {<botania:terraplate>: [[[<soot:signet_antimony>, <soot:stamp_text_raw>, <soot:signet_antimony>],[<botania:rune>, <embers:focal_lens>, <botania:rune:1>], [<botania:rune:2>, <botania:rune:8>, <botania:rune:3>]]]}
};
