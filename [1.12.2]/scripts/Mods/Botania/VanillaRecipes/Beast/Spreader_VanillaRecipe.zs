...
//	name: {<minecraft:output>: [IIngredients]},
  spreader: {<botania:spreader>: [[[<ore:livingwood>, <ore:livingwood>, <ore:livingwood>],[<ore:livingwood>, <ore:petal>, <lordcraft:crystal_basic_nature>], [<ore:livingwood>, <ore:livingwood>, <ore:livingwood>]]]}
};
