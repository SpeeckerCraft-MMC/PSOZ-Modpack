...
static modExtern as string = "lordcraft";
...
//	name: {<minecraft:output>: [IIngredients]},
  magnetring: {<botania:magnetring>: [[[<botania:lens:10>, <ore:ingotManasteel>, <lordcraft:ingot_magic>],[<ore:ingotManasteel>, null, <ore:ingotManasteel>], [<lordcraft:ingot_magic>, <ore:ingotManasteel>, <lordcraft:ingot_magic>]]]}
};
