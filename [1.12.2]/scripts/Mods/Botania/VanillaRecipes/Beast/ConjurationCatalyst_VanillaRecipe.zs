#priority -99
#packmode beast
#modloaded crafttweaker botania lordcraft abyssalcraft
...
static modExtern as string = "lordcraft_abyssalcraft";
...
//	name: {<minecraft:output>: [IIngredients]},
  conjurationcatalyst: {<botania:conjurationcatalyst>: [[[<lordcraft:runestone:216>, <ore:elvenPixieDust>, <lordcraft:runestone:216>],[<ore:ingotElvenElementium>, <botania:alchemycatalyst>, <ore:ingotElvenElementium>], [<ore:livingrock>, <ore:blockAbyssalnite>, <ore:livingrock>]]]}
};
