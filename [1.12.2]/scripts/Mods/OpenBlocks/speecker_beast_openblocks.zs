...
recipes.addShaped("speecker_beast_openblocks_scaffolding_x4", <openblocks:scaffolding> * 4, [[<ore:slabWood>, <ore:slabWood>, <ore:slabWood>],[null, <ore:stickWood>, null], [<ore:stickWood>, null, <ore:stickWood>]]);
