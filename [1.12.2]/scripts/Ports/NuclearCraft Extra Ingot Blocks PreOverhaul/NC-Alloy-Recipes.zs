...
var blocks = {cmn: [<contenttweaker:cmnblock>, <contenttweaker:cmningot>]} as IItemStack[][string];

var oreBlocks = { <ore:blockCarbonManganese>: <contenttweaker:cmnblock>} as IItemStack[IOreDictEntry];
<ore:ingotCarbonManganese>.add(<contenttweaker:cmningot>);
<ore:blockCarbonManganese>.add(<contenttweaker:cmnblock>);
...
<ore:blockManganeseDioxide>: <contenttweaker:mno2block>} as IItemStack[IOreDictEntry];
