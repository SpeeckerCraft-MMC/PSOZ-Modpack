...
val activateScript = scripts.Ports.MetallurgyTweaks.metallurgyTweaksConfig.activateThermalOptionalScripts;
//val removeThermalToolsArmor = scripts.metallurgyTweaksConfig.thermalRemoveConflictingThermalArmorToolRecipes;
val removeThermalToolsArmor = scripts.Ports.MetallurgyTweaks.metallurgyTweaksConfig.thermalRemoveConflictingThermalArmorToolRecipes;
