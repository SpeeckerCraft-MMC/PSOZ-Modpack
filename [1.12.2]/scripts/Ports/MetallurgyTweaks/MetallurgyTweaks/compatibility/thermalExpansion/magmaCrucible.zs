...
val nuggetArray = scripts.Ports.MetallurgyTweaks.MetallurgyTweaks.metallurgyTweaksGlobalVariables.nuggets;
val ingotArray = scripts.Ports.MetallurgyTweaks.MetallurgyTweaks.metallurgyTweaksGlobalVariables.ingots;
val blockArray = scripts.Ports.MetallurgyTweaks.MetallurgyTweaks.metallurgyTweaksGlobalVariables.blocks;
val oreArray = scripts.Ports.MetallurgyTweaks.MetallurgyTweaks.metallurgyTweaksGlobalVariables.ores;
val liquidArray = scripts.Ports.MetallurgyTweaks.MetallurgyTweaks.metallurgyTweaksGlobalVariables.liquids;
